...
const chunkDocument = (doc, chunkSize = 500, overlap = 100) => {
    const chunks = [];
...
const calculateRelevanceScore = (query, content) => {
...
export const handleDocumentQuery = async (args) => {
    ...
    try {
        ...
        const sortedChunks = scoredChunks.sort((a, b) => (b.relevanceScore || 0) - (a.relevanceScore || 0));
